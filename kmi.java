...
//Kui on ülekaalus siis kuvab milline peaks olema suurim normaalkaal		
	...
	while(tulemus>25){
		...
		tulemus=(kaal)/(pikkus*pikkus);
			if(tulemus<=25){
				System.out.println("Teie normaalkaal peaks olema maksimaalselt "+Math.round(kaal*100.0)/100.0+" kilogrammi.");
				System.out.println("------------------------------------------------------------------------");
				}
...
//Kui on alakaalus siis kuvab milline peaks olema vähim normaalkaal			
	while(tulemus<19){
		...
		tulemus=(kaal)/(pikkus*pikkus);
			if(tulemus>=19){
				System.out.println("Teie normaalkaal peaks olema vähemalt "+Math.round(kaal*100.0)/100.0+" kilogrammi.");
				System.out.println("------------------------------------------------------------------------");
				}
